...
suspend fun UseHttpClient.getAll(offset: Int = 0, limit: Int = DEFAULT_LIMIT): EventData = json {
...
suspend fun UseHttpClient.getRunning(offset: Int = 0, limit: Int = DEFAULT_LIMIT): EventData = json {
    method = HttpMethod.Post
    url(EVENT_RUNNING)
    attributes.put(OFFSET_KEY, offset)
    attributes.put(LIMIT_KEY, limit)
...
suspend fun UseHttpClient.getUpcoming(offset: Int = 0, limit: Int = DEFAULT_LIMIT): EventData = json {
    method = HttpMethod.Post
    url(EVENT_UPCOMING)
    attributes.put(OFFSET_KEY, offset)
    attributes.put(LIMIT_KEY, limit)
